...
# 3.3.1 Historical Meetings (1st, 9th to 19th)
print("Injecting historical meeting data (1st, 9th to 19th)...")

meetings["১ম"] = {
    "meeting_number": "১ম",
    "meeting_date": "৩ ফেব্রুয়ারি, ২০০২",
    "agendas": [
        {
            "agenda_no": "০১",
            "subject": "বিটিআরসি-এর নতুন অফিস স্থাপন ও তরঙ্গ পরিবীক্ষণ (Radio Monitoring) যন্ত্রপাতি স্থানান্তর প্রসঙ্গে।",
            "decision": "কমিশনের কার্যক্রম শুরু ও পরিচালনার জন্য মতিঝিলের ১৭ দিলকুশায় অস্থায়ী কার্যালয় নির্ধারণ এবং রেডিও মনিটরিং যন্ত্রপাতি স্থাপনের জন্য অবিলম্বে অফিস স্থান ভাড়া করার প্রয়োজনীয় ব্যবস্থা গ্রহণের সিদ্ধান্ত গৃহীত হয়।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "কমিশনের কার্যক্রম শুরু ও রেডিও মনিটরিং যন্ত্রপাতি স্থাপনের জন্য অফিস স্থান ভাড়া করার বিষয় আলোচনা করা হয়।",
                "tables": [],
                "implementation": "চেয়ারম্যান ও সংশ্লিষ্ট কমিশনারবৃন্দ।",
                "assigned_inspector": "কমিশন সচিবালয়",
                "case_status": "নিষ্পন্ন"
            }
        },
        {
            "agenda_no": "০২",
            "subject": "অফিস আসবাবপত্র ও লজিস্টিকস সামগ্রী ক্রয় প্রসঙ্গে।",
            "decision": "নতুন জনবলের ভিত্তিতে আসবাবপত্র ও যন্ত্রপাতি ক্রয়ের প্রক্রিয়া অবিলম্বে শুরু করার জন্য ভাইস-চেয়ারম্যান এবং কমিশনার এন.এইচ. চৌধুরীকে দায়িত্ব প্রদান করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "কমিশনের কাজের সুবিধার্থে প্রয়োজনীয় লজিস্টিকস ও আসবাবপত্র ক্রয়ের বিষয় উপস্থাপন করা হয়।",
                "tables": [],
                "implementation": "ভাইস-চেয়ারম্যান ও কশিনার এন.এইচ. চৌধুরী।",
                "assigned_inspector": "কমিশন সচিবালয়",
                "case_status": "নিষ্পন্ন"
            }
        },
        {
            "agenda_no": "০৩",
            "subject": "কমিশনের জন্য প্রয়োজনীয় যানবাহন সংগ্রহ প্রসঙ্গে।",
            "decision": "কমিশনের কাজের জন্য প্রয়োজনীয় যানবাহন সংগ্রহের প্রক্রিয়া গ্রহণের সিদ্ধান্ত হয় এবং কমিশনার মোঃ রেজাউল হক ও এন. এইচ. চৌধুরীকে দায়িত্ব প্রদান করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "কমিশনের কার্যক্রম গতিশীল করতে যানবাহন ক্রয়ের প্রস্তাব আলোচনা করা হয়।",
                "tables": [],
                "implementation": "কমিশনার মোঃ রেজাউল হক ও এন. এইচ. চৌধুরী।",
                "assigned_inspector": "কমিশন সচিবালয়",
                "case_status": "নিষ্পন্ন"
            }
        },
        {
            "agenda_no": "০৪",
            "subject": "রাজস্ব খাতে পদ সৃজন ও লোকবল নিয়োগ (৫৯টি পদ) অনুমোদন প্রসঙ্গে।",
            "decision": "সংস্থাপন ও অর্থ মন্ত্রণালয়ে মোট ৫৯টি পদ রাজস্ব খাতে সৃজনের প্রস্তাব সামান্য সংশোধনপূর্বক পুনরায় প্রেরণের সিদ্ধান্ত গৃহীত হয়।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "বিটিআরসির কার্যক্রম পরিচালনার জন্য মোট ৫৯টি পদ রাজস্ব খাতে সৃজনের প্রস্তাব নিয়ে আলোচনা।",
                "tables": [],
                "implementation": "কমিশনার খন্দকার আবু বকর ও চেয়ারম্যান।",
                "assigned_inspector": "কমিশন সচিবালয়",
                "case_status": "অনুমোদিত"
            }
        },
        {
            "agenda_no": "০৫",
            "subject": "২০০১-২০০২ অর্থ বছরের আংশিক বাজেট অনুমোদন প্রসঙ্গে।",
            "decision": "কমিশনের কার্যক্রম ও ব্যয় নির্বাহের জন্য ফেব্রুয়ারি-জুন ২০০২ মেয়াদের বাজেট চূড়ান্ত অনুমোদনের জন্য অর্থ মন্ত্রণালয়ের সাথে জরুরি যোগাযোগের সিদ্ধান্ত হয়।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "ফেব্রুয়ারি-জুন ২০০২ মেয়াদের বাজেট প্রস্তাব অর্থ মন্ত্রণালয়ে পাঠানোর পর চূড়ান্ত অনুমোদনের তাগাদা প্রদানের সিদ্ধান্ত।",
                "tables": [],
                "implementation": "কমিশনার খন্দকার আবু বকর ও চেয়ারম্যান।",
                "assigned_inspector": "কমিশন সচিবালয়",
                "case_status": "অনুমোদিত"
        ...
        {
            "agenda_no": "০৬",
            "subject": "টেলিকমিউনিকেশন অ্যাক্ট ২০০১ অনুযায়ী রেগুলেটরি বিধিমালা ও প্রবিধান প্রণয়নে পরামর্শক নিয়োগ।",
            "decision": "টেলিকমিউনিকেশন অ্যাক্ট ২০০১ অনুযায়ী বিধি ও প্রবিধান প্রণয়নের উদ্দেশ্যে একজন অভিজ্ঞ আইনি পরামর্শক নিয়োগের প্রক্রিয়া গ্রহণের সিদ্ধান্ত হয়।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "কমিশনের রেগুলেটরি ফ্রেমওয়ার্ক শক্তিশালী করার জন্য পরামর্শক নিয়োগের আলোচনা।",
                "tables": [],
                "implementation": "কমিশনার খন্দকার আবু বকর ও সংশ্লিষ্ট বিভাগ।",
                "assigned_inspector": "কমিশন সচিবালয়",
                "case_status": "চলমান"
            }
        },
        {
            "agenda_no": "০৭",
            "subject": "কর্মকর্তা-কর্মচারীদের কাজের দায়িত্ব ও কার্যপরিধি (Broad Outline) নির্ধারণ।",
            "decision": "চূড়ান্ত কার্যপরিধি অনুমোদনের পূর্ব পর্যন্ত সাময়িকভাবে কাজের দায়িত্ব বণ্টনের খসড়া অনুসরণের সিদ্ধান্ত হয় এবং ভাইস-চেয়ারম্যানকে দায়িত্ব প্রদান করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "কমিশনের কর্মকর্তা-কর্মচারীদের কাজের দায়িত্ব বণ্টনের খসড়া উপস্থাপন।",
                "tables": [],
                "implementation": "ভাইস-চেয়ারম্যান ও কমিশনার মোঃ রেজাউল হক।",
                "assigned_inspector": "কমিশন সচিবালয়",
                "case_status": "অনুমোদিত"
            }
        },
        {
            "agenda_no": "০৮",
            "subject": "কমিশনের ভারপ্রাপ্ত সচিব নিয়োগ প্রসঙ্গে।",
            "decision": "বিটিআরসি প্রকল্পের উপ-পরিচালক জনাব মোঃ রেজাউল কাদেরকে ভারপ্রাপ্ত সচিবের দায়িত্ব প্রদান করার সিদ্ধান্ত গৃহীত হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "বিটিআরসির সাচিবিক দায়িত্ব পালনের জন্য সাময়িক নিয়োগ।",
                "tables": [],
                "implementation": "চেয়ারম্যান মহোদয়।",
                "assigned_inspector": "কমিশন সচিবালয়",
                "case_status": "নিষ্পন্ন"
            }
        },
        {
            "agenda_no": "০৯",
            "subject": "বিটিআরসি প্রকল্পের দায়িত্ব কমিশনের নিকট অর্পণ প্রসঙ্গে।",
            "decision": "টেলিকম মন্ত্রণালয়ের অধীনস্থ বিটিআরসি প্রকল্পের দায়িত্ব কমিশনের নিকট অর্পণের জন্য পরিকল্পনা কমিশনকে চিঠি প্রেরণের সিদ্ধান্ত গৃহীত হয়।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "বিটিআরসি প্রকল্পের বাস্তবায়ন ও নিয়ন্ত্রণ সরাসরি কমিশনের নিকট হস্তান্তরের প্রস্তাব।",
                "tables": [],
                "implementation": "চেয়ারম্যান মহোদয়।",
                "assigned_inspector": "কমিশন সচিবালয়",
                "case_status": "নিষ্পন্ন"
...
meetings["৯ম"] = {
    "meeting_number": "৯ম",
    "meeting_date": "০৮ জুলাই, ২০০২",
    "agendas": [
        {
            "agenda_no": "০১",
            "subject": "পূর্ববর্তী ৮ম কমিশন সভার সিদ্ধান্ত বাস্তবায়ন ও অগ্রগতি পর্যালোচনা এবং বিটিআরসি প্রকল্প সমাপ্তি প্রসঙ্গে।",
            "decision": "৮ম সভার কার্যবিবরণী সর্বসম্মতভাবে অনুমোদন করা হলো এবং বিটিআরসি প্রকল্প সমাপ্তি ও নতুন প্রজেক্ট ড্রাফটিং এর অগ্রগতি পর্যালোচনা করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "বিগত সভার সিদ্ধান্ত ও চলমান বিটিআরসি প্রকল্পের কার্যাবলী সমাপ্তি পর্যালোচনা।",
                "tables": [],
                "implementation": "কমিশনার এন. এইচ. চৌধুরী।",
                "assigned_inspector": "কমিশন সচিবালয়",
                "case_status": "নিষ্পন্ন"
            }
        },
        {
            "agenda_no": "০২",
            "subject": "বিটিআরসির পরামর্শক কমিটি (Consultative Committee) গঠন প্রসঙ্গে।",
            "decision": "পরামর্শক কমিটির কার্যপরিধি (Terms of Reference) এবং প্রস্তাবিত সদস্যদের নাম নীতিগতভাবে অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "টেলিকম খাতের স্টেকহোল্ডারদের সাথে সমন্বয়ের জন্য পরামর্শক কমিটি গঠনের প্রস্তাব।",
                "tables": [],
                "implementation": "কমিশনার মোঃ রেজাউল হক।",
                "assigned_inspector": "কমিশন সচিবালয়",
                "case_status": "অনুমোদিত"
            }
        },
        {
            "agenda_no": "০৩",
            "subject": "আইএসপি (ISP) এবং ভিস্যাট (VSAT) লাইসেন্সিং ফি পুনর্নির্ধারণ প্রসঙ্গে।",
            "decision": "আইসিটি খাতকে উৎসাহিত করতে ভিস্যাট ব্যান্ডউইথ ও স্পিড ভিত্তিক বাৎসরিক ফি হ্রাস করে ৩০ হাজার টাকা (৬৪ কেবিপিএস) থেকে সর্বোচ্চ ৪ লক্ষ টাকা (২ এমবিপিএস ও তদূর্ধ্ব) পুনর্নির্ধারণ করা হলো। লাইসেন্স ও স্থানান্তর ফি অপরিবর্তিত থাকবে।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "ভিস্যাট ও আইএসপি সেবার প্রসার এবং ইন্টারনেট ব্যবহারে গ্রাহকদের উৎসাহিত করার উদ্দেশ্যে লাইসেন্স ও স্পিড ফি হ্রাসের প্রস্তাব।",
                "tables": [
                    {
                        "headers": ["ভিস্যাট স্পিড রেঞ্জ", "পূর্ববর্তী ফি (বার্ষিক)", "সংশোধিত ফি (বার্ষিক)"],
                        "rows": [
                            ["৬৪ কেবিপিএস", "৪০,০০০/- টাকা", "৩০,০০০/- টাকা"],
                            ["১২৮ কেবিপিএস", "৭৫,০০০/- টাকা", "৬০,০০০/- টাকা"],
                            ["২৫৬ কেবিপিএস", "১.৪০ লক্ষ টাকা", "১.২০ লক্ষ টাকা"],
                            ["৫১২ কেবিপিএস", "২.৫০ লক্ষ টাকা", "২.০০ লক্ষ টাকা"],
                            ["১ এমবিপিএস", "৩.৫০ লক্ষ টাকা", "৩.০০ লক্ষ টাকা"],
                            ["২ এমবিপিএস ও তদূর্ধ্ব", "৫.০০ লক্ষ টাকা", "৪.০০ লক্ষ টাকা"]
                        ]
                    }
                ],
                "implementation": "অর্থ ও হিসাব বিভাগ এবং সিস্টেমস এন্ড সার্ভিসেস বিভাগ।",
                "assigned_inspector": "সিস্টেম ও লাইসেন্সিং বিভাগ",
                "case_status": "অনুমোদিত"
            }
        },
        {
            "agenda_no": "০৪",
            "subject": "ডোমেস্টিক ডাটা কমিউনিকেশন সার্ভিস প্রোভাইডার (DDCSP) লাইসেন্সিং নীতিমালা সংক্রান্ত।",
            "decision": "ডাটা সার্ভিসের গুরুত্ব বিবেচনায় অন্তর্বর্তীকালীন সময়ে বিভিন্ন প্রতিষ্ঠানকে কেস-বাই-কেস (Case-by-Case) ভিত্তিতে লাইসেন্সিং এর আওতায় আনার সিদ্ধান্ত গৃহীত হয়।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "টেলিকম অ্যাক্ট অনুযায়ী ডাটা কমিউনিকেশন সার্ভিস চালুর নিমিত্তে গাইডলাইন তৈরির প্রস্তাব।",
                "tables": [],
                "implementation": "সিস্টেমস অ্যান্ড সার্ভিসেস বিভাগ।",
                "assigned_inspector": "সিস্টেম বিভাগ",
                "case_status": "চলমান"
            }
        },
        {
            "agenda_no": "০৫",
            "subject": "কমিশনের কার্য বণ্টন (Allocation of Business) এবং সাংগঠনিক কাঠামো প্রণয়ন।",
            "decision": "ভাইস-চেয়ারম্যান মহোদয় কর্তৃক প্রণীত 'Allocation of Business' এর খসড়া অনুমোদন করা হলো এবং এ আলোকে সাংগঠনিক কাঠামো ও জনবলের প্রস্তাব পরবর্তী সভায় উপস্থাপনের নির্দেশ দেওয়া হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "কমিশনের কার্যক্রম সুনির্দিষ্ট ও দায়িত্বশীল করতে কার্য বণ্টনের প্রস্তাব।",
                "tables": [],
                "implementation": "ভাইস-চেয়ারম্যান মহোদয়।",
                "assigned_inspector": "কমিশন সচিবালয়",
                "case_status": "অনুমোদিত"
            }
        },
        {
            "agenda_no": "০৬",
            "subject": "কমিশনের শূন্য পদে জনবল নিয়োগ পরীক্ষা গ্রহণ প্রসঙ্গে।",
            "decision": "কম্পিউটার অপারেটর ও ব্যক্তিগত সহকারীদের নিয়োগ পরীক্ষা আগামী ১৫ আগস্ট ২০০২ এর মধ্যে সম্পন্ন করার এবং পরিচালক ও উপ-পরিচালক পদসমূহ ডেপুটেশনে পূরণের সিদ্ধান্ত গৃহীত হয়।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "কমিশনের শূন্য পদে জরুরি ভিত্তিতে লোকবল নিয়োগের বিষয় আলোচনা।",
                "tables": [],
                "implementation": "পরিচালক (প্রশাসন) ও কমিশন সচিবালয়।",
                "assigned_inspector": "প্রশাসন বিভাগ",
                "case_status": "নিষ্পন্ন"
            }
        },
        {
            "agenda_no": "০৭",
            "subject": "তরঙ্গ ব্যবস্থাপনা বা স্পেকট্রাম ব্যবস্থাপনা কমিটির ৩য় সভার সিদ্ধান্ত অনুমোদন।",
            "decision": "২৬ জুন ২০০২ এ অনুষ্ঠিত তরঙ্গ ব্যবস্থাপনা কমিটির সভার সুপারিশসমূহ সর্বসম্মতভাবে অনুমোদন দেওয়া হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "তরঙ্গ বরাদ্দ ও মূল্য নির্ধারণ সংক্রান্ত কারিগরি কমিটির প্রস্তাব।",
                "tables": [],
                "implementation": "স্পেকট্রাম বিভাগ।",
                "assigned_inspector": "তরঙ্গ ব্যবস্থাপনা বিভাগ",
                "case_status": "অনুমোদিত"
            }
        }
    ]
...
meetings["১০ম"] = {
    "meeting_number": "১০ম",
    "meeting_date": "২৫ জুলাই, ২০০২",
    "agendas": [
        {
            "agenda_no": "০১",
            "subject": "\"Strengthening of BTRC\" শীর্ষক ৫ বছর মেয়াদী প্রকল্প প্রস্তাব অনুমোদন প্রসঙ্গে।",
            "decision": "বিটিআরসিকে প্রাতিষ্ঠানিক ও কারিগরিভাবে শক্তিশালীকরণের উদ্দেশ্যে ৫ বছর মেয়াদী প্রকল্প প্রস্তাব এডিপিতে অন্তর্ভুক্তির জন্য অনুমোদন করা হলো এবং কমিশনার এন.এইচ. চৌধুরীর অনুপস্থিতিতে কমিশনার মোঃ রেজাউল হককে দায়িত্ব প্রদান করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "কমিশনের প্রযুক্তিগত দক্ষতা বৃদ্ধি ও দীর্ঘমেয়াদী উন্নয়নের জন্য এডিপি প্রকল্পের প্রস্তাব।",
                "tables": [],
                "implementation": "কমিশনার মোঃ রেজাউল হক।",
                "assigned_inspector": "কমিশন সচিবালয়",
                "case_status": "অনুমোদিত"
        ...
        {
            "agenda_no": "০২",
            "subject": "ডোমেস্টিক ডাটা কমিউনিকেশন সার্ভিস প্রোভাইডার (DDCSP) অন্তর্বর্তীকালীন আদেশ জারি সংক্রান্ত।",
            "decision": "ডাটা কমিউনিকেশন সেবা আইনসংগত কাঠামোর অধীনে পরিচালনার জন্য চূড়ান্ত লাইসেন্সিং নীতিমালার পূর্বে অন্তর্বর্তীকালীন আদেশ (Interim Order) অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "ডাটা নেটওয়ার্ক সার্ভিস প্রোভাইডার ও ব্যবহারকারীদের কেস-বাই-কেস ভিত্তিতে অনুমোদনের প্রস্তাব।",
                "tables": [],
                "implementation": "সিস্টেমস অ্যান্ড সার্ভিসেস বিভাগ।",
                "assigned_inspector": "সিস্টেম বিভাগ",
                "case_status": "অনুমোদিত"
        ...
        {
            "agenda_no": "০৩",
            "subject": "সাইবার ক্যাফে (Cyber Cafe) আইএসপি সাব-লিজ নীতিমালা অনুমোদন প্রসঙ্গে।",
            "decision": "সাইবার ক্যাফে ও রিটেইল ইন্টারনেট ব্যবহারের সুবিধার জন্য আইএসপি লাইসেন্সধারী কর্তৃক সাব-লিজ প্রদানের নীতিমালা অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "ইন্টারনেটের কভারেজ বাড়ানোর জন্য সাইবার ক্যাফে সাব-লিজ গাইডলাইনের খসড়া আলোচনা।",
                "tables": [],
                "implementation": "সিস্টেমস অ্যান্ড সার্ভিসেস বিভাগ।",
                "assigned_inspector": "সিস্টেম বিভাগ",
                "case_status": "অনুমোদিত"
        ...
        {
            "agenda_no": "০৪",
            "subject": "দেশব্যাপী ইন্টারনেট সেবা (Nationwide ISP) নীতিমালা সংশোধন।",
            "decision": "ইন্টারনেট সেবার পরিধি বাড়াতে দেশব্যাপী ইন্টারনেট সেবাদাতা (Nationwide ISP) লাইসেন্সের শর্তাবলীতে প্রয়োজনীয় সংশোধনী প্রস্তাব অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "আইএসপি লাইসেন্সিং আরও সহজ ও উন্মুক্ত করার কারিগরি প্রস্তাব।",
                "tables": [],
                "implementation": "সিস্টেমস অ্যান্ড সার্ভিসেস বিভাগ।",
                "assigned_inspector": "সিস্টেম বিভাগ",
                "case_status": "অনুমোদিত"
        ...
        {
            "agenda_no": "০৫",
            "subject": "ভিস্যাট প্রোভাইডার এবং ভিস্যাট ইউজার (VSAT Provider & User) লাইসেন্সিং শর্তাবলী নির্ধারণ।",
            "decision": "ভিস্যাট ব্যবহারকারী এবং সেবাদাতাদের লাইসেন্সিং প্রক্রিয়া সহজীকরণ এবং বকেয়া ফি পরিশোধের সময়সীমা নির্ধারণ করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "ভিস্যাট প্রযুক্তির লাইসেন্স বিধিমালা ও ফি পরিশোধের প্রস্তাব।",
                "tables": [],
                "implementation": "সিস্টেমস অ্যান্ড সার্ভিসেস বিভাগ ও স্পেকট্রাম বিভাগ।",
                "assigned_inspector": "সিস্টেম ও তরঙ্গ বিভাগ",
                "case_status": "অনুমোদিত"
            }
        }
    ]
...
meetings["১১তম"] = {
    "meeting_number": "১১তম",
    "meeting_date": "১৪ সেপ্টেম্বর, ২০০২",
    "agendas": [
        {
            "agenda_no": "০১",
            "subject": "রেডিও ইকুইপমেন্ট ও ওয়্যারলেস সরঞ্জামাদি আমদানি, উৎপাদন ও ব্যবহার লাইসেন্স প্রসঙ্গে।",
            "decision": "বেতার যন্ত্রপাতি ও রেডিও ইকুইপমেন্ট (Radio Equipment & Apparatus) এর লাইসেন্স প্রদান, দখল ও আমদানির জন্য নতুন ফি ও গাইডলাইন অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "বেতার তরঙ্গের নিরাপত্তা ও চোরাচলান রোধে রেডিও ইকুইপমেন্টের লাইসেন্স কঠোর করার প্রস্তাব।",
                "tables": [],
                "implementation": "স্পেকট্রাম বিভাগ।",
                "assigned_inspector": "তরঙ্গ বিভাগ",
                "case_status": "অনুমোদিত"
            }
        },
        {
            "agenda_no": "০২",
            "subject": "তরঙ্গ ও রেডিও সরঞ্জামের ফি, রয়্যালটি এবং লেভি নির্ধারণ।",
            "decision": "ফ্রিকোয়েন্সি ব্যবহারের জন্য বাৎসরিক রয়্যালটি এবং স্পেকট্রাম ফি আদায়ের নতুন রূপরেখা প্রণয়ন ও বিলিং নির্দেশিকা অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "মোবাইল ও অন্যান্য রেডিও ব্যবহারকারীদের স্পেকট্রাম রয়্যালটি আদায়ের নীতিমালা।",
                "tables": [],
                "implementation": "অর্থ বিভাগ ও স্পেকট্রাম বিভাগ।",
                "assigned_inspector": "তরঙ্গ ও অর্থ বিভাগ",
                "case_status": "অনুমোদিত"
            }
        },
        {
            "agenda_no": "০৩",
            "subject": "অপারেটর লাইসেন্সিং এর সাধারণ নীতিমালা ও শর্তাবলী (Principles and Conditions of Operator Licencing)।",
            "decision": "সকল টেলিকম অপারেটরের লাইসেন্সিং এর সাধারণ শর্ত ও লাইসেন্স ইস্যুর রূপরেখা অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "টেলিকম ও ডাটা অপারেটরদের সাধারণ লাইসেন্স শর্ত সম্বলিত ড্রাফট উপস্থাপন।",
                "tables": [],
                "implementation": "সিস্টেমস অ্যান্ড সার্ভিসেস বিভাগ।",
                "assigned_inspector": "সিস্টেম বিভাগ",
                "case_status": "অনুমোদিত"
        ...
        {
            "agenda_no": "০৪",
            "subject": "লাইসেন্স নবায়ন, স্থগিতকরণ এবং লাইসেন্স বাতিলকরণ বিধিমালা।",
            "decision": "লাইসেন্স বিধি ভঙ্গ বা বকেয়া পরিশোধে ব্যর্থতার ক্ষেত্রে লাইসেন্স বাতিল বা স্থগিতকরণের আইনি প্রক্রিয়া অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "লাইসেন্সধারী প্রতিষ্ঠানসমূহের কমপ্লায়েন্স ও শাস্তিমূলক ব্যবস্থা গ্রহণের আইনি গাইডলাইন।",
                "tables": [],
                "implementation": "লিগ্যাল ও লাইসেন্সিং বিভাগ।",
                "assigned_inspector": "আইন বিভাগ",
                "case_status": "অনুমোদিত"
            }
        },
        {
            "agenda_no": "০৫",
            "subject": "কমিশনের বাৎসরিক প্রতিবেদন (Annual Report) ও নিরীক্ষা প্রতিবেদন (Audit Report) প্রকাশ প্রসঙ্গে।",
            "decision": "২০০১-২০০২ অর্থ বছরের কমিশনের নিরীক্ষিত অডিট রিপোর্ট এবং বার্ষিক প্রতিবেদন চূড়ান্তভাবে প্রকাশের প্রস্তাব অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "বিটিআরসির প্রথম বার্ষিক প্রতিবেদন ও আর্থিক অডিট রিপোর্ট পর্যালোচনা।",
                "tables": [],
                "implementation": "অর্থ বিভাগ ও সচিবালয়।",
                "assigned_inspector": "অর্থ ও প্রশাসন বিভাগ",
                "case_status": "নিষ্পন্ন"
            }
        }
    ]
...
meetings["১২তম"] = {
    "meeting_number": "১২তম",
    "meeting_date": "১৩ অক্টোবর, ২০০২",
    "agendas": [
        {
            "agenda_no": "০১",
            "subject": "ঢাকায় দক্ষিণ এশীয় টেলিকম রেগুলেটরস কাউন্সিল (SATRC) সভার আয়োজন প্রসঙ্গে।",
            "decision": "ঢাকায় সার্কভুক্ত দেশগুলোর টেলিকম নিয়ন্ত্রক সংস্থার কাউন্সিল (SATRC) সভার সফল আয়োজনের জন্য প্রয়োজনীয় বাজেট ও প্রশাসনিক প্রস্তুতি অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "সার্ক অঞ্চলের নিয়ন্ত্রকদের ঢাকার সম্মেলন আয়োজনের প্রস্তুতিমূলক আলোচনা।",
                "tables": [],
                "implementation": "কমিশন সচিবালয় ও আন্তর্জাতিক উইং।",
                "assigned_inspector": "প্রশাসন বিভাগ",
                "case_status": "অনুমোদিত"
            }
        },
        {
            "agenda_no": "০২",
            "subject": "দেশের অভ্যন্তরীণ টেলিকম খাতের প্রবৃদ্ধি ও লাইসেন্সিং শর্ত পর্যালোচনা।",
            "decision": "ডাটা ও ভয়েস অপারেটরদের কার্যক্রম এবং কোয়ালিটি অফ সার্ভিস (QoS) উন্নয়ন সংক্রান্ত গাইডলাইন অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "গ্রাহকদের গুণগত সেবা নিশ্চিতকরণ সংক্রান্ত মনিটরিং রূপরেখা।",
                "tables": [],
                "implementation": "সিস্টেমস অ্যান্ড সার্ভিসেস বিভাগ।",
                "assigned_inspector": "সিস্টেম বিভাগ",
                "case_status": "অনুমোদিত"
...
meetings["১৩তম"] = {
    ...
    "agendas": [
        {
            "agenda_no": "০১",
            "subject": "স্পেকট্রাম বরাদ্দ ও তরঙ্গ মূল্য নির্ধারণ নীতিমালা পর্যালোচনা।",
            "decision": "বিভিন্ন ব্যান্ডের স্পেকট্রাম ফি পুনর্নির্ধারণ এবং ফ্রিকোয়েন্সি মনিটরিং স্টেশনসমূহের কাজের অগ্রগতি পর্যালোচনা করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "তরঙ্গ বরাদ্দ আধুনিকীকরণ এবং মনিটরিং স্টেশন স্থাপনের সাইট সিলেকশন।",
                "tables": [],
                "implementation": "স্পেকট্রাম বিভাগ।",
                "assigned_inspector": "তরঙ্গ বিভাগ",
                "case_status": "অনুমোদিত"
        ...
        {
            "agenda_no": "০২",
            "subject": "আইটি ও টেলিকম পরামর্শকদের সেবার মেয়াদ বৃদ্ধি প্রসঙ্গে।",
            "decision": "কমিশনের প্রযুক্তিগত ও নীতিগত সহায়তা প্রদানের লক্ষ্যে নিয়োজিত বিদেশি ও দেশি পরামর্শকদের কার্যাদেশের মেয়াদ বৃদ্ধির প্রস্তাব অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "পরামর্শকদের চুক্তির মেয়াদ বৃদ্ধি ও কাজের অগ্রগতি প্রতিবেদন দাখিল।",
                "tables": [],
                "implementation": "প্রশাসন ও অর্থ বিভাগ।",
                "assigned_inspector": "প্রশাসন বিভাগ",
                "case_status": "নিষ্পন্ন"
            }
        }
...
meetings["১৪তম"] = {
    "meeting_number": "১৪তম",
    "meeting_date": "২২ ডিসেম্বর, ২০০২",
    "agendas": [
        {
            "agenda_no": "০১",
            "subject": "দেশের স্পেকট্রাম বা তরঙ্গ বণ্টন (Spectrum Distribution) নীতিমালা অনুমোদন।",
            "decision": "আন্তর্জাতিক টেলিকমিউনিকেশন ইউনিয়ন (ITU) এর গাইডলাইন অনুযায়ী দেশের ফ্রিকোয়েন্সি ব্যান্ড প্ল্যান এবং সর্বোত্তম তরঙ্গ ব্যবহারের রূপরেখা অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "স্পেকট্রাম অপটিমাইজেশন ও আইটিইউ নির্ধারিত স্ট্যান্ডার্ড অনুযায়ী তরঙ্গ বণ্টন।",
                "tables": [],
                "implementation": "স্পেকট্রাম বিভাগ।",
                "assigned_inspector": "তরঙ্গ বিভাগ",
                "case_status": "অনুমোদিত"
        ...
        {
            "agenda_no": "০২",
            "subject": "মেসার্স ওয়ার্ল্ড টেল (WorldTel) এর ঢাকা ওয়ান পিএসটিএন লাইসেন্স আবেদন পর্যালোচনা।",
            "decision": "মেসার্স ওয়ার্ল্ড টেল বাংলাদেশ লিমিটেড এর ঢাকা ওয়ান জোনের পিএসটিএন লাইসেন্সিং গাইডলাইনের শর্তাবলী পর্যালোচনা ও লাইসেন্স হস্তান্তরের প্রস্তাব অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "ওয়ার্ল্ড টেলের ঢাকা ওয়ান পিএসটিএন লাইসেন্স চালুর অগ্রগতি ও লাইসেন্স হস্তান্তর বিষয় আলোচনা।",
                "tables": [],
                "implementation": "সিস্টেমস অ্যান্ড সার্ভিসেস বিভাগ ও আইনি বিভাগ।",
                "assigned_inspector": "সিস্টেম ও আইন বিভাগ",
                "case_status": "অনুমোদিত"
            }
        },
        {
            "agenda_no": "০৩",
            "subject": "প্রিপেইড কলিং কার্ড (Prepaid Calling Card) ও ভ্যালু অ্যাডেড সার্ভিস লাইসেন্স গাইডলাইন।",
            "decision": "গ্রাহক পর্যায়ে সহজে ব্যবহারের উদ্দেশ্যে প্রিপেইড কলিং কার্ড এবং টেলিকম ভ্যালু অ্যাডেড সেবার লাইসেন্সিং গাইডলাইন অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "কলিং কার্ডের মাধ্যমে সস্তায় সেবা প্রদান ও গাইডলাইন অনুমোদনের প্রস্তাব।",
                "tables": [],
                "implementation": "সিস্টেমস অ্যান্ড সার্ভিসেস বিভাগ।",
                "assigned_inspector": "সিস্টেম বিভাগ",
                "case_status": "অনুমোদিত"
        ...
        {
            "agenda_no": "০৪",
            "subject": "ইন্টারনেট প্রটোকল ভিত্তিক অবৈধ ভয়েস কল (VoIP) প্রতিরোধ প্রসঙ্গে।",
            "decision": "অনুমোদন ব্যতীত আইপি ভিত্তিক ভয়েস কল (VoIP) প্রদানকারী প্রতিষ্ঠানসমূহের চিহ্নিতকরণ ও তাদের বিরুদ্ধে আইনি ব্যবস্থা গ্রহণের সিদ্ধান্ত গৃহীত হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "অবৈধ ভিওআইপি কল বন্ধ ও সনাক্তকরণে কারিগরি ব্যবস্থা গ্রহণের প্রস্তাব।",
                "tables": [],
                "implementation": "ইএন্ডআই ডিরেক্টরেট ও লিগ্যাল বিভাগ।",
                "assigned_inspector": "ইএন্ডআই বিভাগ",
                "case_status": "অনুমোদিত"
            }
        }
    ]
...
meetings["১৫তম"] = {
    "meeting_number": "১৫তম",
    "meeting_date": "২৮ জানুয়ারি, ২০০৩",
    "agendas": [
        {
            "agenda_no": "০১",
            "subject": "ভিস্যাট হাব (VSAT Hub) ও ভিস্যাট প্রোভাইডারদের জন্য তরঙ্গ বরাদ্দ প্রসঙ্গে।",
            "decision": "মেসার্স ভিস্যাট প্রোভাইডারদের আবেদনের প্রেক্ষিতে তাদের ডেডিকেটেড ভিস্যাট হাব স্থাপনের উদ্দেশ্যে ৩.৪-৩.৭ GHz ব্যান্ডে তরঙ্গ বরাদ্দের প্রস্তাব অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "ভিস্যাট হাব ও ভিস্যাট ব্যবহারকারীদের ব্যান্ডউইথ ও ফ্রিকোয়েন্সি প্রস্তাব।",
                "tables": [],
                "implementation": "স্পেকট্রাম বিভাগ।",
                "assigned_inspector": "তরঙ্গ বিভাগ",
                "case_status": "অনুমোদিত"
        ...
        {
            "agenda_no": "০২",
            "subject": "ডমেস্টিক ডাটা কমিউনিকেশন সার্ভিস প্রোভাইডার (DDCSP) লাইসেন্স চূড়ান্তকরণ।",
            "decision": "ডাটা কমিউনিকেশন লাইসেন্সিং এর সাধারণ শর্তাবলী এবং নিরাপত্তা বিধিমালা অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "ডোমেস্টিক ডাটা সেবার প্রসার ও গাইডলাইন চূড়ান্তকরণের প্রস্তাব।",
                "tables": [],
                "implementation": "সিস্টেমস অ্যান্ড সার্ভিসেস বিভাগ।",
                "assigned_inspector": "সিস্টেম বিভাগ",
                "case_status": "অনুমোদিত"
...
meetings["১৬তম"] = {
    "meeting_number": "১৬তম",
    "meeting_date": "১৯ ফেব্রুয়ারি, ২০০৩",
    "agendas": [
        {
            "agenda_no": "০১",
            "subject": "গ্রামীণফোন লিমিটেড (GrameenPhone) এর ফ্রিকোয়েন্সি বরাদ্দ ও বকেয়া পরিশোধ প্রসঙ্গে।",
            "decision": "গ্রামীণফোনের আবেদনের প্রেক্ষিতে তরঙ্গ বরাদ্দ এবং তাদের রাজস্ব বকেয়া পরিশোধের নোটিশ প্রেরণের সিদ্ধান্ত গৃহীত হয়।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "গ্রামীণফোনের তরঙ্গ চাহিদার প্রেক্ষিতে কারিগরি কমিটির সুপারিশ উপস্থাপন।",
                "tables": [],
                "implementation": "স্পেকট্রাম বিভাগ ও অর্থ বিভাগ।",
                "assigned_inspector": "তরঙ্গ ও অর্থ বিভাগ",
                "case_status": "অনুমোদিত"
            }
        },
        {
            "agenda_no": "০২",
            "subject": "স্যাটেলাইট ভিত্তিক ব্রডব্যান্ড ইন্টারনেট (Satellite-based Direct Broadband) প্রবর্তন প্রসঙ্গে।",
            "decision": "দেশে প্রথমবার স্যাটেলাইট ভিত্তিক সরাসরি ব্রডব্যান্ড ইন্টারনেট সেবা চালু করার লাইসেন্সিং নীতিমালা নীতিগতভাবে অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "উচ্চগতির স্যাটেলাইট ব্রডব্যান্ড ইন্টারনেট সেবা প্রসারের প্রস্তাব।",
                "tables": [],
                "implementation": "সিস্টেমস অ্যান্ড সার্ভিসেস বিভাগ।",
                "assigned_inspector": "সিস্টেম বিভাগ",
                "case_status": "অনুমোদিত"
...
meetings["১৭তম"] = {
    "meeting_number": "১৭তম",
    "meeting_date": "০৫ এপ্রিল, ২০০৩",
    "agendas": [
        {
            "agenda_no": "০১",
            "subject": "ল্যান্ডফোন (PSTN) এবং ভিওআইপি (VoIP) ট্রাফিক মনিটরিং সিস্টেম স্থাপন।",
            "decision": "দেশের অভ্যন্তরীণ পিএসটিএন ল্যান্ডফোনের সেবার মান ও আন্তর্জাতিক ভয়েস ট্রাফিক (VoIP) পরিবীক্ষণের জন্য বিশেষ মনিটরিং স্থাপন প্রকল্প অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "অবৈধ আইপি কল ও ভয়েস কল পরিবীক্ষণ স্টেশন স্থাপন পরিকল্পনা।",
                "tables": [],
                "implementation": "ইএন্ডআই ডিরেক্টরেট ও স্পেকট্রাম বিভাগ।",
                "assigned_inspector": "ইএন্ডআই বিভাগ",
                "case_status": "অনুমোদিত"
            }
        },
        {
            "agenda_no": "০২",
            "subject": "আইটি পার্ক (IT Park) এবং হাইটেক পার্ক সমূহের টেলিকম অবকাঠামো স্থাপন।",
            "decision": "প্রস্তাবিত আইটি পার্কের জন্য উচ্চগতির ফাইবার অপটিক নেটওয়ার্ক ও ওয়ান-স্টপ টেলিকম সুবিধা প্রদানের সিদ্ধান্ত গৃহীত হয়।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "তথ্যপ্রযুক্তি পার্কের জন্য টেলিকমিউনিকেশন কভারেজ বাড়ানোর প্রস্তাব।",
                "tables": [],
                "implementation": "সিস্টেমস অ্যান্ড সার্ভিসেস বিভাগ।",
                "assigned_inspector": "সিস্টেম বিভাগ",
                "case_status": "অনুমোদিত"
        ...
        {
            "agenda_no": "০৩",
            "subject": "ইউএনডিপি (UNDP) ও আইটিইউ (ITU) এর কারিগরি ও প্রযুক্তিগত সহায়তা প্রকল্প।",
            "decision": "বিটিআরসির প্রাতিষ্ঠানিক দক্ষতাবর্ধনে ইউএনডিপি ও আইটিইউ এর কারিগরি বিশেষজ্ঞদের নিয়োগের প্রস্তাব অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "জাতিসংঘের প্রযুক্তিগত সহায়তা গ্রহণ সংক্রান্ত আলোচনা।",
                "tables": [],
                "implementation": "প্রশাসন ও সচিবালয়।",
                "assigned_inspector": "প্রশাসন বিভাগ",
                "case_status": "অনুমোদিত"
            }
        }
...
meetings["১৮তম"] = {
    ...
    "agendas": [
        {
            "agenda_no": "০১",
            "subject": "ইন্টারনেট সেবাদাতা (ISP) ও ভিস্যাট অপারেটরদের জন্য বাৎসরিক রয়্যালটি (Royalty) ফি সংশোধন প্রসঙ্গে।",
            "decision": "আইএসপি অ্যাসোসিয়েশনের আবেদনের প্রেক্ষিতে বাৎসরিক রয়্যালটি ফি আদায়ের পদ্ধতি সহজ এবং সংশোধিত স্ল্যাব অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "আইএসপিদের রয়্যালটি ফি আদায় সহজীকরণের প্রস্তাব পর্যালোচনা।",
                "tables": [],
                "implementation": "অর্থ বিভাগ ও সিস্টেমস এন্ড সার্ভিসেস বিভাগ।",
                "assigned_inspector": "অর্থ ও সিস্টেম বিভাগ",
                "case_status": "অনুমোদিত"
            }
        },
        {
            "agenda_no": "০২",
            "subject": "তরঙ্গ অপব্যবহার প্রতিরোধ ও কভারেজ অনুপ্রবেশ পর্যালোচনা।",
            "decision": "দেশের সীমান্তে বিদেশী মোবাইল কভারেজ অনুপ্রবেশ ও অনুপ্রবেশ জনিত সমস্যা পরিদর্শনে বিশেষ কারিগরি তদন্ত দল গঠনের নির্দেশ দেওয়া হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "সীমান্তবর্তী এলাকায় তরঙ্গ কভারেজ অনুপ্রবেশ পরিদর্শনের প্রস্তাব।",
                "tables": [],
                "implementation": "স্পেকট্রাম বিভাগ ও ইএন্ডআই ডিরেক্টরেট।",
                "assigned_inspector": "তরঙ্গ পরিদর্শক দল",
                "case_status": "অনুমোদিত"
            }
        }
    ]
...
meetings["১৯তম"] = {
    "meeting_number": "১৯তম",
    "meeting_date": "০৮ জুন, ২০০৩",
    "agendas": [
        {
            "agenda_no": "০১",
            "subject": "দেশব্যাপী অপটিক্যাল ফাইবার নেটওয়ার্ক (Fiber Optic Network) স্থাপন ও অবকাঠামো শেয়ারিং।",
            "decision": "দেশে দ্রুত ব্রডব্যান্ড ইন্টারনেট সম্প্রসারণের লক্ষ্যে রেলওয়ে ও বিদ্যুৎ গ্রিডের আন্ডারগ্রাউন্ড ফাইবার অপটিক ক্যাবল শেয়ারিং নীতিমালা অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "বিদ্যুৎ গ্রিড ও রেলের অব্যবহৃত অপটিক ফাইবার ক্যাবল লিজ সংক্রান্ত প্রস্তাব।",
                "tables": [],
                "implementation": "সিস্টেমস অ্যান্ড সার্ভিসেস বিভাগ।",
                "assigned_inspector": "সিস্টেম বিভাগ",
                "case_status": "অনুমোদিত"
        ...
        {
            "agenda_no": "০২",
            "subject": "ভয়েস ওভার আইপি (VoIP) নীতিমালার খসড়া প্রস্তুতকরণ প্রসঙ্গে।",
            "decision": "টেলিযোগাযোগ খাতের বিশ্ববাজারের সাথে তাল মিলিয়ে ভয়েস ওভার আইপি (VoIP) বৈধভাবে চালুর উদ্দেশ্যে একটি খসড়া লাইসেন্সিং গাইডলাইন প্রণয়নের সিদ্ধান্ত গৃহীত হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "আইপি টেলিফোনি ও ভিওআইপি চালুর বিষয়ে খসড়া নীতিমালা প্রণয়নের আলোচনা।",
                "tables": [],
                "implementation": "সিস্টেমস অ্যান্ড সার্ভিসেস বিভাগ ও আইনি বিভাগ।",
                "assigned_inspector": "সিস্টেম ও আইন বিভাগ",
                "case_status": "চলমান"
        ...
        {
            "agenda_no": "০৩",
            "subject": "ভ্যালু অ্যাডেড সার্ভিস ও ডাটা সেবার জন্য গেটওয়ে লাইসেন্স।",
            "decision": "মোবাইল ভ্যালু অ্যাডেড সার্ভিস এবং ইন্টারনেটের জন্য ইন্টারন্যাশনাল গেটওয়ে লাইসেন্স গাইডলাইন অনুমোদন করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "নতুন মোবাইল কনটেন্ট সেবা ও গেটওয়ে চালুর প্রস্তাব।",
                "tables": [],
                "implementation": "সিস্টেমস অ্যান্ড সার্ভিসেস বিভাগ।",
                "assigned_inspector": "সিস্টেম বিভাগ",
                "case_status": "অনুমোদিত"
