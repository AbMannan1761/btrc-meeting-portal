...
meetings["307তম"] = {
    ...
    "agendas": [
                ...
                "tables": [
                    {
                        ...
                        "rows": [
                            ["সার্কেল নেটওয়ার্ক", "আই নক্স নেট কমিউনিকেশন", "উত্তরা আদাবরে ও ইন্টারনেট সংযোগ প্রদানে বাধা, তার কাটা ও টিজে বক্স খুলে নেওয়া।", "শুনানিতে ম্যানেজার আরিফ ভুল স্বীকার করেছে এবং ভবিষ্যতে না করার লিখিত প্রতিশ্রুতি দিতে বলা হয়েছে।"],
        ...
        },
        {
            ...
            "fine_amount": "",
            "details": {
                "presentation_summary": "নতুন技术的 ট্রায়াল হিসেবে Direct-to-Cell (D2C) PoC পরীক্ষার জন্য আবেদন করা হয়। স্পেকট্রাম বিভাগের কারিগরি কমিটি পর্যালোচনা করে বাংলালিংক-কে MNC 08 (PLMN 470 08) সাময়িক বরাদ্দের জন্য কমিশন সভায় প্রস্তাব উত্থাপন করে এবং তা অনুমোদিত হয়।",
                "tables": [
                    {
        ...
        },
        {
            ...
            "fine_amount": "",
            "details": {
                "presentation_summary": "টাওয়ার শেয়ারিং লাইসেন্সের শর্তাবলী পরিপালন এবং রোল-আউট লক্ষ্যমাত্রা পূরণে গতিশীলতা আনতে শেয়ার হোল্ডিং কাঠামো পরিবর্তন এবং সময় বাড়ানোর আবেদন জমা দেওয়া হয়। সিস্টেমস অ্যান্ড সার্ভিসেস বিভাগ আবেদনটি বিশ্লেষণ করে ইতিবাচক সুপারিশ করে।",
                "tables": [
                    {
        ...
        {
            "agenda_no": "০৬",
            "subject": "\"Honor Choice\" 브랜드 নামযুক্ত ফিচার ফোন বাংলাদেশে আমদানির উদ্দেশ্যে টাইপ অ্যাপ্রুভাল এবং এনওসি (NOC) প্রদান প্রসঙ্গে।",
            ...
            "fine_amount": "",
            "details": {
                "presentation_summary": "স্থানীয় প্রস্তুতকারী Xtreme এবং মূল কোম্পানি Honor এর ব্র্যান্ড ও ট্রেডমার্ক রেজিস্ট্রেশন তথ্যের ভিত্তিতে \"Honor Choice\" ফিচার ফোনের অনুমোদন আবেদন পর্যালোচনা করা হয়। স্পেকট্রাম বিভাগ এটি আমদানির যোগ্য হিসেবে টাইপ অ্যাপ্রুভালের সুপারিশ করে।",
                "tables": [
                    {
                        "headers": ["ব্র্যান্ড নাম", "মূল প্রতিষ্ঠান", "অনুমোদিত আমদানিকারক/পার্টনার", "আবেদনের ধরণ"],
                        "rows": [
                            ["Honor Choice", "Honor Information Technology Co. Limited (HK)", "Xtreme (Local Assembly & Import Partner)", "International Brand Type Approval"]
                        ]
                    }
                ],
                "implementation": "স্পেকট্রাম বিভাগ।",
                "assigned_inspector": "Spectrum Standardization Division",
                "case_status": "অনুমোদিত"
            }
        },
        {
            "agenda_no": "০৭",
            "subject": "নতুন টেলিকমিউনিকেশন নেটওয়ার্ক ও লাইসেন্সিং পলিসি ২০২৫ বাস্তবায়নের অন্তর্বর্তীকালীন সময়ে NovoTel Ltd. এবং Mir Telecom Ltd. এর বার্ষিক লাইসেন্স ফি কিস্তিতে পরিশোধের সুযোগ প্রদান প্রসঙ্গে।",
            "decision": "আইজিডব্লিউ (IGW) অপারেটরদের আন্তর্জাতিক কল রেট ও ট্রাফিক হ্রাসের ফলে সৃষ্ট চরম আর্থিক সংকট এবং আইসিএসপি (ICSP) লাইসেন্সে রূপান্তরের অন্তর্বর্তীকালীন ট্রানজিশন বিবেচনা করে NovoTel-কে ত্রৈমাসিক কিস্তিতে (BDT ২৫ লক্ষ প্রতি কোয়ার্টার) এবং Mir Telecom-কে মাসিক কিস্তিতে বার্ষিক লাইসেন্স ফি পরিশোধের আবেদন মঞ্জুর করা হলো।",
            "fine_amount": "",
            "details": {
                "presentation_summary": "নতুন পলিসি অনুযায়ী আইজিডব্লিউ লাইসেন্সসমূহ ২০২৭ সালের জুনের মধ্যে আইসিএসপি (ICSP) ক্যাটাগরিতে স্থানান্তরিত হবে। এই অন্তর্বর্তীকালীন সময়ে ব্যবসায়িক ধারাবাহিকতা বজায় রাখতে NovoTel ও Mir Telecom এর লাইসেন্স ফি কিস্তিতে দেওয়ার বিশেষ সুযোগ প্রদান করা হলো।",
                "tables": [
                    {
                        "headers": ["প্রতিষ্ঠান", "লাইসেন্স ধরণ", "অনুমোদিত কিস্তির সুবিধা", "ট্রানজিশনাল পলিসি"],
                        "rows": [
                            ["NovoTel Ltd.", "IGW", "ত্রৈমাসিক কিস্তি (২৫ লক্ষ টাকা প্রতি কোয়ার্টার, ভ্যাট ব্যতীত)", "ICSP লাইসেন্সিং পলিসি ২০২৫"],
                            ["Mir Telecom Ltd.", "IGW", "১২টি সমান মাসিক কিস্তিতে বার্ষিক লাইসেন্স ফি পরিশোধ", "ICSP লাইসেন্সিং পলিসি ২০২৫"]
                        ]
                    }
                ],
                "implementation": "অর্থ, হিসাব ও রাজস্ব বিভাগ এবং ইএন্ডআই ডিরেক্টরেট।",
