...
print("Interactive Reader HTML successfully compiled and saved to:")
print(f"  - {output_html_path} ({os.path.getsize(output_html_path)} bytes)")
print(f"  - {output_index_path} ({os.path.getsize(output_index_path)} bytes)")
